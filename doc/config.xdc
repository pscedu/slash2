...
<oof:span class='prompt_hostname'>mds</oof:span><oof:span class='prompt_meta'>#</oof:span> slmkjrnl -f -b /dev/sdJ1 -n 1048576 -u 0x2a8ae931a776366e
	...
	<oof:pre>
<oof:span class='syn_keyword'>site</oof:span>set</oof:span> zpool_name=<oof:span class='syn_val'>"s2mds_pool"</oof:span>;
<oof:span class='syn_keyword'>site</oof:span>set</oof:span> fsuuid=<oof:span class='syn_val'>"2a8ae931a776366e"</oof:span>;
<oof:span class='syn_keyword'>site</oof:span>set</oof:span> port=<oof:span class='syn_val'>989</oof:span>;
<oof:span class='syn_keyword'>site</oof:span>set</oof:span> nets=<oof:span class='syn_val'>"tcp0 192.168.*.*; sdp0 10.0.0.*"</oof:span>;
</oof:pre>
	...
	<oof:pre>
<oof:span class='syn_keyword'>site</oof:span>set</oof:span> zpool_name="s2mds_pool";
<oof:span class='syn_keyword'>site</oof:span>set</oof:span> fsuuid="2a8ae931a776366e";
<oof:span class='syn_keyword'>site</oof:span>set</oof:span> port=989;
<oof:span class='syn_keyword'>site</oof:span>set</oof:span> nets="tcp0 192.168.*.*; sdp0 10.0.0.*";
<oof:span class='syn_keyword'>site</oof:span>set</oof:span> pref_mds="mds@MYSITE";
<oof:span class='syn_keyword'>site</oof:span>set</oof:span> pref_ios="ion1@MYSITE";
