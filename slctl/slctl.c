...
void
slrpcmdsthr_prdat(const struct psc_ctlmsg_stats *pcst)
{
...
struct psc_ctl_thrstatfmt psc_ctl_thrstatfmts[] = {
	...
	{ slrpcmdsthr_prhdr,	slrpcmdsthr_prdat },
	{ slrpcbethr_prhdr,	slrpcbethr_prdat }
};
