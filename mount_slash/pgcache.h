...
#define BIORQ_ARCHIVER			(1 << 12)
#define BIORQ_EXPIREDLEASE		(1 << 13)
#define BIORQ_MAXRETRIES		(1 << 14)	/* too many retries.. */
#define BIORQ_PENDING			(1 << 15)
#define BIORQ_WAIT			(1 << 16)
#define BIORQ_MFHLIST			(1 << 17)
