...
#define BIORQ_READAHEAD			(1 << 11)
#define BIORQ_AIOWAIT			(1 << 12)
#define BIORQ_ARCHIVER			(1 << 13)
#define BIORQ_EXPIREDLEASE		(1 << 14)
#define BIORQ_MAXRETRIES		(1 << 15)	/* too many retries.. */
#define BIORQ_PENDING			(1 << 16)
#define BIORQ_WAIT			(1 << 17)
#define BIORQ_MFHLIST			(1 << 18)
