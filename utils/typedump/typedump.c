...
#define PRVALX(val)	pr(#val, (unsigned long)(val), 1)
	...
	PRVAL(SLC_OPST_BMAP_FLUSH_COALESCE_CONTIG);
	PRVAL(SLC_OPST_BMAP_FLUSH_COALESCE_EXPIRE);
	PRVAL(SLC_OPST_BMAP_FLUSH_COALESCE_RESTART);
	...
	PRVAL(SLC_OPST_BMAP_LEASE_EXT_WAIT);
	...
	PRVAL(SLC_OPST_BMAP_RELEASE_READ);
	PRVAL(SLC_OPST_BMAP_RELEASE_WRITE);
	PRVAL(SLC_OPST_BMAP_RETRIEVE);
	PRVAL(SLC_OPST_BMAP_WAIT_EMPTY);
	...
	PRVAL(SLC_OPST_DELETE_MARKED);
	PRVAL(SLC_OPST_DELETE_SKIPPED);
	PRVAL(SLC_OPST_DIO_ADD_REQ_FAIL);
	...
	PRVAL(SLC_OPST_DIRCACHE_UNUSED);
	...
	PRVAL(SLC_OPST_FSRQ_READ_ERR);
	PRVAL(SLC_OPST_FSRQ_READ_NOREG);
	PRVAL(SLC_OPST_FSRQ_READ_OK);
	PRVAL(SLC_OPST_FSRQ_WRITE);
	PRVAL(SLC_OPST_FSRQ_WRITE_ERR);
	PRVAL(SLC_OPST_FSRQ_WRITE_OK);
	PRVAL(SLC_OPST_FSYNC);
	PRVAL(SLC_OPST_FSYNCDIR);
	PRVAL(SLC_OPST_GETATTR);
	PRVAL(SLC_OPST_GETXATTR);
	PRVAL(SLC_OPST_GETXATTR_RPC);
	PRVAL(SLC_OPST_LEASE_REFRESH);
	PRVAL(SLC_OPST_LINK);
	PRVAL(SLC_OPST_LISTXATTR);
	PRVAL(SLC_OPST_LISTXATTR_RPC);
	PRVAL(SLC_OPST_LOOKUP);
	...
	PRVAL(SLC_OPST_READDIR_STALE);
	PRVAL(SLC_OPST_READLINK);
	PRVAL(SLC_OPST_READ_ADD_REQ_FAIL);
	PRVAL(SLC_OPST_READ_AHEAD);
	PRVAL(SLC_OPST_READ_AHEAD_CB_ADD);
	PRVAL(SLC_OPST_READ_AHEAD_CB_PAGE);
	PRVAL(SLC_OPST_READ_AHEAD_OVERRUN);
	...
	PRVAL(SLC_OPST_READ_PART_VALID);
	PRVAL(SLC_OPST_READ_RPC_LAUNCH);
	PRVAL(SLC_OPST_RELEASE);
	PRVAL(SLC_OPST_RELEASEDIR);
	...
	PRVAL(SLM_OPST_TRUNCATE_EXTEND);
	PRVAL(SLM_OPST_TRUNCATE_FULL);
	PRVAL(SLM_OPST_TRUNCATE_SAME);
	PRVAL(SLM_OPST_TRUNCATE_SHRINK);
