...
#define PRVALX(val)	pr(#val, (unsigned long)(val), 1)
	...
	PRVAL(NS_SUM_PEND);
	PRVAL(NS_SUM_SUCC);
	PRVAL(OPSTAT_BMAP_CHWRMODE);
	PRVAL(OPSTAT_BMAP_LEASE_EXT);
	PRVAL(OPSTAT_BMAP_RELEASE);
	PRVAL(OPSTAT_BMAP_RETRIEVE);
	PRVAL(OPSTAT_BMPCE_INSERT);
	PRVAL(OPSTAT_CREAT);
	PRVAL(OPSTAT_DIO_CB);
	PRVAL(OPSTAT_DIO_CB_ADD);
	PRVAL(OPSTAT_EXTEND_BMAP_LEASE);
	PRVAL(OPSTAT_FLUSH_ATTR);
	PRVAL(OPSTAT_FSIO_READ);
	PRVAL(OPSTAT_FSIO_READ_FAIL);
	PRVAL(OPSTAT_FSIO_WRITE);
	PRVAL(OPSTAT_FSIO_WRITE_FAIL);
	PRVAL(OPSTAT_FSYNC);
	PRVAL(OPSTAT_GETXATTR);
	PRVAL(OPSTAT_GETXATTR_NOSYS);
	PRVAL(OPSTAT_GETXATTR_RPC);
	PRVAL(OPSTAT_GET_BMAP_LEASE_READ);
	PRVAL(OPSTAT_GET_BMAP_LEASE_WRITE);
	PRVAL(OPSTAT_HANDLE_IO);
	PRVAL(OPSTAT_LISTXATTR);
	PRVAL(OPSTAT_MKDIR);
	PRVAL(OPSTAT_OFFLINE_NO_RETRY);
	PRVAL(OPSTAT_OFFLINE_RETRY);
	PRVAL(OPSTAT_OPEN);
	PRVAL(OPSTAT_OPEN_FAIL);
	PRVAL(OPSTAT_OPEN_SUCCEED);
	PRVAL(OPSTAT_READ);
	PRVAL(OPSTAT_READDIR);
	PRVAL(OPSTAT_READDIR_RETRY);
	PRVAL(OPSTAT_READDIR_RPC);
	PRVAL(OPSTAT_READ_AHEAD);
	PRVAL(OPSTAT_READ_AHEAD_CB);
	PRVAL(OPSTAT_READ_AHEAD_CB_ADD);
	PRVAL(OPSTAT_READ_AIO_NOT_FOUND);
	PRVAL(OPSTAT_READ_CB);
	PRVAL(OPSTAT_READ_CB_ADD);
	PRVAL(OPSTAT_READ_RPC_LAUNCH);
	PRVAL(OPSTAT_REASSIGN_BMAP_LEASE);
	PRVAL(OPSTAT_RECLAIM);
	PRVAL(OPSTAT_RECLAIM_FILE);
	PRVAL(OPSTAT_RECLAIM_FILE_FAIL);
	PRVAL(OPSTAT_RELEASE_BMAP);
	PRVAL(OPSTAT_REMOVEXATTR);
	PRVAL(OPSTAT_RENAME);
	PRVAL(OPSTAT_REOPEN);
	PRVAL(OPSTAT_RMDIR);
	PRVAL(OPSTAT_RPC_PUSH_REQ_FAIL);
	PRVAL(OPSTAT_SETATTR);
	PRVAL(OPSTAT_SETXATTR);
	PRVAL(OPSTAT_SETXATTR_RPC);
	PRVAL(OPSTAT_SLC_FCMH_CTOR);
	PRVAL(OPSTAT_SLC_FCMH_DTOR);
	PRVAL(OPSTAT_SLVR_AIO_REPLY);
	PRVAL(OPSTAT_SRMT_RELEASE);
	PRVAL(OPSTAT_SRMT_WRITE);
	PRVAL(OPSTAT_UNLINK);
	PRVAL(OPSTAT_WRITE);
	PRVAL(SLBREF_MAPPED);
	PRVAL(SLBREF_REAP);
