...
#define PRVALX(val)	pr(#val, (unsigned long)(val), 1)
	...
	PRVAL(SLC_OPST_BIORQ_FETCH_WAIT_USECS);
	...
	PRVAL(SLC_OPST_BMPCE_REAP_SPIN);
	...
	PRVAL(SLC_OPST_FLUSH_WAIT_USECS);
	...
	PRVAL(SLC_OPST_GETBMAP_WAIT_USECS);
	...
	PRVAL(SLI_OPST_READAHEAD_HIT);
	PRVAL(SLI_OPST_READ_WAIT_USECS);
	PRVAL(SLI_OPST_RECLAIM);
	PRVAL(SLI_OPST_RECLAIM_CLOSE);
	PRVAL(SLI_OPST_RECLAIM_FILE);
	PRVAL(SLI_OPST_RELEASE);
