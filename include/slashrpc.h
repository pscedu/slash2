...
#define p_ntoh_u16(u16 v) ntoh16(v)
#define p_ntoh_u32(u32 v) ntoh32(v)

#define p_hton_u16(u16 v) hton16(v)
#define p_hton_u32(u32 v) hton32(v)

#define p_ntoh_s16(s16 v) ntoh16(v)
#define p_ntoh_s32(s32 v) ntoh32(v)

#define p_hton_s16(s16 v) hton16(v)
#define p_hton_s32(s32 v) hton32(v)

#if __BYTE_ORDER == __LITTLE_ENDIAN
# define p_ntoh_u64(u64 v)	((((v) & U64CONST(0x00000000000000ff)) << 56) |	\
...
# define p_hton_u64(u64 v) p_ntoh_u64(v)

# define p_ntoh_s64(s64 v) ERROR
# define p_hton_s64(s64 v) ERROR
#else
# define p_ntoh_u64(u64 v) (v)
# define p_hton_u64(u64 v) (v)

# define p_ntoh_s64(s64 v) (v)
# define p_hton_s64(s64 v) (v)
#endif
