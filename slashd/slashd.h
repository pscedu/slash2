...
enum {
	...
	SLM_OPST_REPLST_ALL,
	SLM_OPST_REMOVEXATTR,
	SLM_OPST_RENAME,
	SLM_OPST_REPL_SCHEDWK,
	SLM_OPST_REPL_SCHEDWK_FAIL,
	SLM_OPST_SETATTR,
	SLM_OPST_SETXATTR,
	SLM_OPST_SLIOD_PING_FAIL,
	SLM_OPST_STATFS,
	SLM_OPST_SYMLINK,
	SLM_OPST_TRUNCATE_EXTEND,
	SLM_OPST_TRUNCATE_FULL,
	SLM_OPST_TRUNCATE_SAME,
	SLM_OPST_TRUNCATE_SHRINK,
	SLM_OPST_UNLINK
};
